		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						<c:forEach items="${demo}" var="testTask">
							<tr>
								<td>${testTask.id }</td>
								<td>${testTask.NazivFajla }</td>
		...
		<div class="container text-center">
			...
			<form action="savetask" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" name="name" value="${demo.NazivFajla}" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">Description</label>
					<div class="col-md-7">
						<input type="text" class="form-control" name="description" value="${demo.NazivFajla}" />
					</div>
				</div>
				<div class="form-group">
